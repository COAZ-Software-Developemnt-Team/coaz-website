...
import AssociateM from "../_components/AssociateM";
import StudentM from "../_components/StudentM";
import LifeM from "../_components/LifeM";
import Honorary from "../_components/Honorary";
import Grounds from "../_components/Grounds";
...
import Legislation from "../_components/Legislation";
import publicHealth from "../_components/Public Health";
import Program from "../_components/Program";
import Provincial from "../_components/Provincial";
import District from "../_components/District";
import Specialized from "../_components/Specialized";
import Ophthalmic from "../_components/Ophthalmic";
import Anaesthetic from "../_components/Anaesthetic";
import Mental from "../_components/Mental";
import Medical from "../_components/Medical";
import Practitioner from "../_components/Practitioner";
import Advanced from "../_components/Advanced";
import HIV from "../_components/HIV";
import Psychiatry from "../_components/Psychiatry";
...
import Delivering from "../_components/Delivering";
import Practice from "../_components/Practice";
import Institution from "../_components/Institutions";
import Advocacy from "../_components/Advocacy";
...
export const findPerson = (position) => {
    return people.find((person) => {
        return person.position.toLowerCase().includes(position.toLowerCase())
    })
}
...
const getProfessionalCategories = () => {
    ...
    for (let category of categories) {
        for (let pfCat of category.professionalCategories) {
            pfCats.push(pfCat);
        }
    }
    return pfCats;
...
export const professionalCategories = {
    ...
    link: '/categories',
    menus: (() => {
        return getProfessionalCategories()
    })()
};
            ...
            EligibilityCriteria: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <p className='w-full h-auto text-lg text-[rgb(100,100,100)] font-jost-book'>
                        Full Membership within the Clinical Officers Association of Zambia (COAZ) shall be individuals
                        who meet
                    ...
                    <div className='flex flex-row space-x-4'>
                        ...
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Successful Completion: Prospective Full Members must have successfully completed accredited
                            clinical
                    ...
                    <div className='flex flex-row space-x-4'>
                        <FaRegCircleDot size={16} className='text-[rgb(85,85,85)] mt-[5px] shrink-0'/>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Valid Practicing license: As a prerequisite, individuals seeking Full Membership must hold
                            valid
            ...
            RightsAndPrivileges: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <div className='flex flex-row space-x-4'>
                        ...
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Participation: Full Members have the right to actively participate in all activities
                    ...
                    <div className='flex flex-row space-x-4'>
                        ...
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Voting Rights: Full Members shall have the right to cast votes in elections, referendums,
                            and any other matters subjected to a vote by the membership
                        </p>
                    </div>
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'c)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Candidacy for Elective Offices: Full Members are eligible to stand for elective offices
                            within
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'e)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Benefits Determined by the National Executive Committee: The National Executive Committee
                            reserves the authority to confer additional benefits and privileges upon Full Members as
                            deemed
                            appropriate
                        </p>
                    </div>
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'f)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Access to Due Process: Members facing disciplinary actions or disputes with the association
                            shall be entitled to due process, including the right to be heard, present evidence, and
                            appeal
            ...
            ObligationsAndResponsibilities: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'b)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Knowledge of Constitution: Members are obligated to familiarize themselves with the content
                            of
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'c)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Professional Ethics: Members shall uphold the highest standards of professional ethics in
                            the
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'d)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Compliance with Regulations: Members shall adhere to any ethical guidelines, codes of
                            conduct,
                    ...
                    <div className='flex flex-row space-x-4'>
                        ...
                        <div className='flex flex-col w-full h-auto space-y-4'>
                            ...
                            <div className='flex flex-row space-x-4'>
                                <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'i.'}</p>
                                <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                                    Timely Payment: Members are required to pay membership subscriptionfees, or any
                                    other
                            ...
                            <div className='flex flex-row space-x-4'>
                                <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'ii.'}</p>
                                <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                                    Consequences of Non-Payment: Failure to fulfill financial obligations may result in
                                    the
                                    suspension of membership benefits or other disciplinary actions as stipulated in
                                    this
                                    Constitution
                                </p>
                            </div>
                        ...
                        <div className='flex flex-col w-full h-auto space-y-4'>
                            ...
                            <div className='flex flex-row space-x-4'>
                                ...
                                <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                                    ...
                                    financial reports, including income, expenditure, and budgetary allocations, subject
                                    to
        ...
        },
        {
            ...
            EligibilityCriteria: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <p className='w-full h-auto text-lg text-[rgb(100,100,100)] font-jost-book'>
                        Associate Membership is designated for individuals engaged in professions allied to clinical
                        medicine, including
                        but not limited to medical researchers, healthcare administrators, or educators. The eligibility
                        criteria for
            ...
            RightsAndPrivileges: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'b)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Non-voting Participation: While Associate Members may participate in discussions and
                            activities,
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'c)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Access to Designated Resources: Associate Members shall have access to specific resources
                            and
        ...
        },
        {
            ...
            EligibilityCriteria: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <p className='w-full h-auto text-lg text-[rgb(100,100,100)] font-jost-book'>
                        Student Membership is open to individuals actively enrolled in recognized clinical
                        officer/clinical
            ...
            RightsAndPrivileges: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'a)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Educational Event Participation: Student Members shall be entitled to attend educational
                            events
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'c)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Access to Resources: Student Members shall have access to resources aimed at supporting
                            their
        ...
        },
        {
            ...
            EligibilityCriteria: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <p className='w-full h-auto text-lg text-[rgb(100,100,100)] font-jost-book'>
                        Life Membership may be conferred upon Full Members in recognition of exceptional contributions
                        to
            ...
            RightsAndPrivileges: () =>
                <div className='flex flex-col space-y-8 w-full h-auto'>
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'a)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Lifetime Access: Life Members shall have lifetime access to Association activities,
                            resources,
                    ...
                    <div className='flex flex-row space-x-4'>
                        <p className='font-jost-book text-[rgb(85,85,85)] text-lg'>{'b)'}</p>
                        <p className='text-lg tracking-wider font-jost-book text-[rgb(85,85,85)]'>
                            Exemption fromSubscription Fees: Life Members shall be exempt from any annual subscription
                            fees
                        </p>
                    </div>
                    <div className='flex flex-row space-x-4'>
...
const checkMenu = (menu, link) => {
    if (menu.link == link) {
        return menu;
    } else if (menu.menus) {
        for (let subMenu of menu.menus) {
            let found = checkMenu(subMenu, link);
            if (found) {
                return found;
            }
        }
...
export const findMenu = (menus, link) => {
    for (let menu of menus) {
        let found = checkMenu(menu, link);
        if (found) {
            return found;
        }
    }
